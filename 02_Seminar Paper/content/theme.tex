...
\usepackage[
    ...
    pdftitle={Bachelor Tehsis},
    pdfsubject={Enhanced Classification },
    pdfkeywords={words},
    unicode=true
]{hyperref} 
...
%Kopfzeile rechts: \includegraphics[scale=0.025]{graphics/layout/siemenslogo.png}
...
\definecolor{siemensgray}{gray}{0.5} % die Farbe grau wird definiert
...
\definecolor{siemenscoolgray}{cmyk}{0.55, 0.31, 0.25, 0.02}
...
\newcommand{\location}{\textbf{\scshape Location}}
\newcommand{\indoors}{{\scshape Indoors}}
\newcommand{\outdoors}{{\scshape Outdoors}}


\newcommand{\motion}{\textbf{\scshape Motion}}
\newcommand{\stationary}{{\scshape Stationary}}
\newcommand{\moving}{{\scshape Moving}}
\newcommand{\bike}{{\scshape Bike}}
\newcommand{\car}{{\scshape Car}}


\newcommand{\conversation}{\textbf{\scshape Conversation}}
\newcommand{\noise}{{\scshape Noise}}
\newcommand{\conversationclass}{{\scshape Conversation}}


\newcommand{\grouping}{\textbf{\scshape Grouping}}
\newcommand{\group}{{\scshape Group}}
\newcommand{\individual}{{\scshape Individual}}
